...
import 'package:ptba_mdt/data/remote/http_operator_activity_api.dart';
  ...
  runApp(
    ProviderScope(
      overrides: [
        ...
        shiftRepositoryProvider.overrideWithValue(ShiftRepositoryImpl()),
        activityEventRepositoryProvider.overrideWithValue(
          ActivityEventRepositoryImpl(),
        ),
        operatorActivityApiProvider.overrideWithValue(
          HttpOperatorActivityApi.fromEnvironment(),
        ),
      ],
      child: const MdtApp(),
    ),
